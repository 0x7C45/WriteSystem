...
- `insert-citations --plan citations.jsonl [--superscript] [--dry-run] [--validate]`
...
$CLI edit insert-citations --input in.docx --output out.docx --plan citations.jsonl --threshold 0.80 --validate
```
